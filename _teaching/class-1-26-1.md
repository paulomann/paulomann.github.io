...
semester: "26-1"
permalink: /teaching/class-1-26-1
    ...
    <div class="ufrj-schedule">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Ter 10/03</td>
                    <td colspan="3" style="text-align: center; font-weight: bold;">Funcionamento do curso e brainstorming do trabalho da disciplina</td>
                </tr>
...
<section class="course-section">
  ...
  <section class="course-section">
    ...
    <div class="section-content">
      <ul class="evaluation">
        <li>✅ 1 Prova individual escrita (P1)</li>
        <li>✅ 1 Trabalho em grupo (P2)</li>
        <li>✅ 1 Prova de Reposição (PR) - apenas com justificativa de acordo com o regulamento da universidade. Substitui a nota da P1 apenas.</li>
